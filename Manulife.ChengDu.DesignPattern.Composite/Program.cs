//using Manulife.ChengDu.DesignPattern.Composite.InitializeVersion;
using Manulife.ChengDu.DesignPattern.Composite.RefactoredVersion;
using System;
...
namespace Manulife.ChengDu.DesignPattern.Composite
{
